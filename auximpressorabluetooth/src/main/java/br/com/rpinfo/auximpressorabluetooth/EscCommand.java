...
/**
 * Codigo retirado de biblioteca do GPPrint (gprintersdkv2.1.4.jar)
...
public class EscCommand {
    ...
    public void setCommand(Vector<Byte> command) {
    ...
    public String genCodeC(String content) {
        ...
        bytes.add(Byte.valueOf(String.valueOf(123)));
        bytes.add(Byte.valueOf(String.valueOf(67)));

        int i;
        for (int i2 = 0; i2 < len; i2 += 2) {
            i2 = (content.charAt(i2) - 48) * 10;
            int bits = content.charAt(i2 + 1) - 48;
            int current = i2 + bits;
